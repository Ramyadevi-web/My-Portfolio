...
<section className="container-fluid even-div py-5">
     ...
     <div className='row'>
        <div className='col-12 col-lg-6 order-lg-1 d-flex justify-content-center'>
         <img src='src/assets/attendance.png' className='project-image' alt='project screenshot'/>
        </div>
     ...
     {/* Axios CRUD */}
      <div className='row mt-5'>
        <div className='col-12 col-lg-6 d-flex justify-content-center'>
         <img src='src/assets/CRUD.PNG' className='project-image order-lg-2' alt='project screenshot'/>
        </div>
        <div className='col-12 mt-4 col-lg-6 mt-lg-0 justify-content-center align-items-center align-content-center 
         justify-items-center'>
         <div className=' d-flex align-items-center align-content-center 
     ...
     {/* Todo App */}
      <div className='row mt-5'>
        <div className='col-12 col-lg-6 order-lg-2 d-flex justify-content-center'>
         <img src='src/assets/todo.png' className='project-image' alt='project screenshot'/>
        </div>
        <div className='col-12 mt-4 col-lg-6 mt-lg-0 justify-content-center align-items-center align-content-center 
         justify-items-center'>
         <div className=' d-flex align-items-center align-content-center 
      ...
      {/* React Router Demo */}
        ...
        <div className='col-12 col-lg-6 d-flex justify-content-center order-lg-1'>
         <img src='src/assets/router.png' className='project-image ' alt='project screenshot'/>
        </div>
        <div className='col-12 mt-4 col-lg-6 mt-lg-0 justify-content-center align-items-center align-content-center 
      ...
      {/* Shopping Page  */}
       ...
       <div className='row mt-5'>
        <div className='col-12 col-lg-6 d-flex justify-content-center order-lg-2'>
         <img src='src/assets/shop.png' className='project-image' alt='project screenshot'/>
        </div>
        <div className='col-12 mt-4 col-lg-6 mt-lg-0 justify-content-center align-items-center align-content-center 
         justify-items-center'>
         <div className=' d-flex align-items-center align-content-center 
